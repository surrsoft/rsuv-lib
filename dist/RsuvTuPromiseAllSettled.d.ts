...
export declare class PElemAsau66 {
...
export declare class RsuvTuPromiseAllSettled {
     ...
     * @param cbRejected (3) --
     */
    static handle<T, S>(pResults: Array<PElemAsau66>, cbFulfilled: (value: any) => T, cbRejected: (reason?: string) => S): Array<T | S>;
}
