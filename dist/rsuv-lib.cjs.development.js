  ...
  RsuvTuTree.accum = function accum(arr, fieldNameValues, fieldNameId, isUniqueIds) {
    ...
    if (arr.length > 0) {
      ...
      return new RsuvResultTibo({
        success: true,
        value: ret,
        successCode: exports.RsuvAsau90.SUCCESS_CODE_1
      });
    }
...
exports.RsuvTxNumIntDiap = RsuvTxNumIntDiap;
exports.RsuvTxSort = RsuvTxSort;
exports.RsuvTxString = RsuvTxString;
exports.RsuvTxStringAB = RsuvTxStringAB;
exports.RsuvTxStringAC = RsuvTxStringAC;
exports.RsuvTxStringACB = RsuvTxStringACB;
exports.RsuvTxStringACC = RsuvTxStringACC;
exports.RsuvTxStringAD = RsuvTxStringAD;
exports.RsuvTxStringADB = RsuvTxStringADB;
